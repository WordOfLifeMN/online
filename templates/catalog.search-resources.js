...
const searchAndHighlight = () => {
    ...
    if (!query) {
        // Show all resource divs if query is empty
    ...
    resourceDivs.forEach(resourceDiv => {
        ...
        const searchables = resourceDiv.querySelectorAll('.searchable');
        ...
        searchables.forEach(searchable => {
            ...
            if (textContent.toLowerCase().includes(query.toLowerCase())) {
                ...
                if (originalHtml) {
                    ...
                    if (!firstMatch) {
                        firstMatch = resourceDiv.querySelector('mark');
                    }
                }
            } else {
        ...
        // Show or hide the resource div based on match
        resourceDiv.style.display = matchFound ? '' : 'none';
    });
